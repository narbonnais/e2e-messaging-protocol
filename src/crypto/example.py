...
def main():
    ...
    crypto_service = CryptoService(algorithm=rsa_algorithm, key_encoding=pem_encoding)
    ...
    is_valid = crypto_service.verify_signature(public_key_pem, signature, message)
